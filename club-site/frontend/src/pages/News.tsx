            ...
            {data.totalPages > 1 && (
              <div className="mt-10 flex items-center justify-center gap-2">
                <button
                  ...
                  className="rounded-full border border-navy-200 px-4 py-1.5 text-sm font-medium text-navy-700 hover:bg-navy-50 disabled:opacity-30 disabled:hover:bg-transparent"
                >
                  Précédent
                </button>
